...
public class BookDaoImpl implements BookDao {
	...
	public Integer addBook(Book book) {
       ...
       String add="INSERT INTO `book` (`book-code`,`title`,`author`,`category`,`create_date`,`no-of-copies`,`created_by`,`status`) VALUES(?,?,?,?,?,?,?,1)";
            ...
            pstmt.setInt(6, book.getNoOfCopies());
	...
	public Integer updateBookCopies() {
		Integer row=null;
		try {
			String update="update book set `no-ofcopies`= `no-of-copies`-1 where status > 1";
